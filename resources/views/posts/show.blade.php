    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="p-8">
                ...
                <div class="flex items-center gap-4 mb-6 pb-6 border-b border-gray-200">
                    <div class="flex items-center gap-3">
                        <div class="w-12 h-12 bg-gray-300 rounded-full flex items-center justify-center text-lg font-semibold">
                ...
                <div class="mt-6 flex items-center gap-4">
                    ...
                    <a href="https://twitter.com/intent/tweet?url={{ urlencode(request()->url()) }}&text={{ urlencode($post->title) }}" target="_blank" class="text-sky-500 hover:text-sky-600">
        ...
        <section class="bg-white rounded-lg shadow-md p-8">
                ...
                <form action="{{ route('posts.comments.store', $post->slug) }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea id="content" name="content" required rows="5"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-none @error('content') border-red-500 @enderror"
            ...
            <div class="space-y-6" id="comments-list">
                ...
                @empty
                    <p class="text-gray-500 text-center py-4">Brak komentarzy. Bądź pierwszy!</p>
                @endforelse
            </div>
        </section>
        ...
        <section class="mt-12">
            ...
            <div class="grid gap-6 md:grid-cols-3">
                ...
                @empty
                    <p class="col-span-3 text-gray-500 text-center py-4">Brak powiązanych artykułów.</p>
                @endforelse
            </div>
        </section>
