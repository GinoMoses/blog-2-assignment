<x-layout>
    ...
    <div class="max-w-3xl mx-auto my-8">
        ...
        <form method="POST" action="{{ route('posts.update', $post->slug) }}" enctype="multipart/form-data" id="post-form" class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <script>window.postContent = @json(old('content', $post->content));</script>
    ...
    <script>
        ...
        // Load existing content into Trix
        function loadContent() {
            const trixEditor = document.querySelector('trix-editor');
            if (trixEditor && window.postContent && trixEditor.editor) {
                trixEditor.editor.insertHTML(window.postContent);
            }
        }
